// Catalogue de 100 biens pour ENNE BTP Cameroun
// Images générées dynamiquement par mots-clés pour assurer pertinence et unicité

const SECTOR_KEYWORDS = {
  'Nos Services': 'chantier,de,construction,bâtiment,architecture,ingénieur,gros,oeuvre',
  'Opportunités': 'chantier,de,construction,bâtiment'
};
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@gmail.com', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
